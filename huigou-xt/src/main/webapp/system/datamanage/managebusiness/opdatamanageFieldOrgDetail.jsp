...
<form class="hg-form" method="post" action="" id="opdatamanageFieldForm">
	...
	<x:hidden name="columnDataType"/>
	<x:hidden name="isOrgCondition" id="pageIsOrgCondition"/>
	<div class="hg-form-row">
		<x:inputC name="dataKindCode" required="true" label="资源编码" maxLength="32" labelCol="2" fieldCol="4" />
		<x:selectC name="dataKind" list="OrgPermissionKinds" label="权限类型" required="true"  labelCol="2" fieldCol="4"/>
	</div>
	<div class="hg-form-row">
	...
	<div class="hg-form-row">
		...
		<x:inputC name="manageType" required="false" label="基础管理权限" maxLength="32" labelCol="2" fieldCol="4" match="englishCode"/>
	</div>
	<div class="hg-form-row">
