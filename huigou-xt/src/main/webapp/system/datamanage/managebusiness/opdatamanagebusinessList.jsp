...
<head>
    ...
    <x:script src="/system/datamanage/managebusiness/opdatamanagebusinessList.js"/>
</head>
<body>
<div class="container-fluid">
    <div id="layout">
        ...
        <div position="center" title="数据管理权限业务类型列表">
            ...
            <form class="hg-form ui-hide" method="post" action="" id="queryMainForm">
                ...
                <x:hidden name="dataManageFullId"/>
                <x:inputC name="queryDataManageName" required="false" label="管理权限" maxLength="32" labelCol="1" wrapper="select"/>
                <x:inputC name="paramValue" required="false" label="权限关键字" maxLength="32" labelCol="1"/>
